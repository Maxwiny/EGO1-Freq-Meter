...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../freq_meter.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../freq_meter.gen/sources_1/ip/ila_0_1/hdl/verilog" \
