...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../freq_meter.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../freq_meter.gen/sources_1/ip/ila_0_1/hdl/verilog" \
